...
; WRAP-DAG: @__ejit_icache_fn_root = internal global [16 x ptr] [ptr @root_miss,
; WRAP-DAG: @__ejit_icache_fn_helper = internal global [16 x ptr] [ptr @helper_miss,
; WRAP-LABEL: define i32 @root(i8 %cell, ptr %cfg)
; WRAP: jit_entry:
; WRAP: musttail call i32 %ejit_ic_fn(i8 %cell, ptr %cfg)
...
; WRAP-NEXT: entry:
; WRAP-NOT: jit_entry
; WRAP-LABEL: define internal i32 @root_miss
; WRAP: call i32 @ejit_taskpool_compile_or_get_bound
; WRAP-LABEL: define internal i32 @helper_miss
; WRAP: call i32 @ejit_taskpool_compile_or_get_bound
